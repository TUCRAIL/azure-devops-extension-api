...
export class ReleaseRestClient extends RestClientBase {
    ...
    public async getApprovals(
        ...
        ): Promise<WebApi.PagedList<Release.ReleaseApproval>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<Release.ReleaseApproval>>await response.text().then(deserializeVssJsonObject);
    ...
    public async getReleaseDefinitions(
        ...
        ): Promise<WebApi.PagedList<Release.ReleaseDefinition>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<Release.ReleaseDefinition>>await response.text().then(deserializeVssJsonObject);
            body.continuationToken = response.headers.get("x-ms-continuationtoken");
            return body;
        });
    }
    ...
    public async getDeployments(
        ...
        maxStartedTime?: Date,
        sourceBranch?: string
        ): Promise<WebApi.PagedList<Release.Deployment>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<Release.Deployment>>await response.text().then(deserializeVssJsonObject);
            body.continuationToken = response.headers.get("x-ms-continuationtoken");
            return body;
        });
    }
    ...
    public async getReleases(
        ...
        path?: string
        ): Promise<WebApi.PagedList<Release.Release>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<Release.Release>>await response.text().then(deserializeVssJsonObject);
            body.continuationToken = response.headers.get("x-ms-continuationtoken");
            return body;
        });
    }
