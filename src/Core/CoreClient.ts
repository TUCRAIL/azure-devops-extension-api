...
export class CoreRestClient extends RestClientBase {
    ...
    public async getProjects(
        ...
        ): Promise<WebApi.PagedList<Core.TeamProjectReference>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<Core.TeamProjectReference>>await response.text().then(deserializeVssJsonObject);
