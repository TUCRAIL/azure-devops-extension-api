...
export class TestPlanRestClient extends RestClientBase {
    ...
    public async getTestConfigurations(
        ...
        ): Promise<WebApi.PagedList<TestPlan.TestConfiguration>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<TestPlan.TestConfiguration>>await response.text().then(deserializeVssJsonObject);
    ...
    public async getTestCaseList(
        ...
        isRecursive?: boolean
        ): Promise<WebApi.PagedList<TestPlan.TestCase>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<TestPlan.TestCase>>await response.text().then(deserializeVssJsonObject);
            body.continuationToken = response.headers.get("x-ms-continuationtoken");
            return body;
        });
    }
    ...
    public async getPointsList(
        ...
        includePointDetails?: boolean,
        isRecursive?: boolean
        ): Promise<WebApi.PagedList<TestPlan.TestPoint>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<TestPlan.TestPoint>>await response.text().then(deserializeVssJsonObject);
            body.continuationToken = response.headers.get("x-ms-continuationtoken");
            return body;
        });
    }
    ...
    public async getTestVariables(
        project: string,
        continuationToken?: string
        ): Promise<WebApi.PagedList<TestPlan.TestVariable>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<TestPlan.TestVariable>>await response.text().then(deserializeVssJsonObject);
            body.continuationToken = response.headers.get("x-ms-continuationtoken");
            return body;
        });
    }
