...
export class ServiceEndpointRestClient extends RestClientBase {
    ...
    public async getServiceEndpointExecutionRecords(
        ...
        ): Promise<WebApi.PagedList<ServiceEndpoint.ServiceEndpointExecutionRecord>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<ServiceEndpoint.ServiceEndpointExecutionRecord>>await response.text().then(deserializeVssJsonObject);
