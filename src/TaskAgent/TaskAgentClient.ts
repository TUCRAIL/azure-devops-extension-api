...
export class TaskAgentRestClient extends RestClientBase {
    ...
    public async getAgentRequestsForQueue(
        ...
        ): Promise<WebApi.PagedList<TaskAgent.TaskAgentJobRequest>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<TaskAgent.TaskAgentJobRequest>>await response.text().then(deserializeVssJsonObject);
    ...
    public async getDeploymentGroups(
        ...
        top?: number,
        ids?: number[]
        ): Promise<WebApi.PagedList<TaskAgent.DeploymentGroup>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<TaskAgent.DeploymentGroup>>await response.text().then(deserializeVssJsonObject);
            body.continuationToken = response.headers.get("x-ms-continuationtoken");
            return body;
        });
    }
    ...
    public async getDeploymentGroupsMetrics(
        ...
        continuationToken?: string,
        top?: number
        ): Promise<WebApi.PagedList<TaskAgent.DeploymentGroupMetrics>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<TaskAgent.DeploymentGroupMetrics>>await response.text().then(deserializeVssJsonObject);
            body.continuationToken = response.headers.get("x-ms-continuationtoken");
            return body;
        });
    }
    ...
    public async getEnvironmentDeploymentExecutionRecords(
        ...
        continuationToken?: string,
        top?: number
        ): Promise<WebApi.PagedList<TaskAgent.EnvironmentDeploymentExecutionRecord>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<TaskAgent.EnvironmentDeploymentExecutionRecord>>await response.text().then(deserializeVssJsonObject);
            body.continuationToken = response.headers.get("x-ms-continuationtoken");
            return body;
        });
    }
    ...
    public async getEnvironments(
        ...
        continuationToken?: string,
        top?: number
        ): Promise<WebApi.PagedList<TaskAgent.EnvironmentInstance>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<TaskAgent.EnvironmentInstance>>await response.text().then(deserializeVssJsonObject);
            body.continuationToken = response.headers.get("x-ms-continuationtoken");
            return body;
        });
    }
    ...
    public async getDeploymentTargets(
        ...
        enabled?: boolean,
        propertyFilters?: string[]
        ): Promise<WebApi.PagedList<TaskAgent.DeploymentMachine>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<TaskAgent.DeploymentMachine>>await response.text().then(deserializeVssJsonObject);
            body.continuationToken = response.headers.get("x-ms-continuationtoken");
            return body;
        });
    }
    ...
    public async getVirtualMachines(
        ...
        tags?: string[],
        top?: number
        ): Promise<WebApi.PagedList<TaskAgent.VirtualMachine>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<TaskAgent.VirtualMachine>>await response.text().then(deserializeVssJsonObject);
            body.continuationToken = response.headers.get("x-ms-continuationtoken");
            return body;
        });
    }
