...
export class PolicyRestClient extends RestClientBase {
    ...
    public async getPolicyConfigurations(
        ...
        scope?: string,
        policyType?: string
        ): Promise<WebApi.PagedList<Policy.PolicyConfiguration>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<Policy.PolicyConfiguration>>await response.text().then(deserializeVssJsonObject);
