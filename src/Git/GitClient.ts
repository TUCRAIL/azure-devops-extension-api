...
export class GitRestClient extends RestClientBase {
    ...
    public async getEnablementStatus(
        ...
        skip?: number,
        take?: number
        ): Promise<Git.AdvSecEnablementStatus[]> {
    ...
    public async updateEnablementStatus(
        enablementUpdates: Git.AdvSecEnablementUpdate[]
        ): Promise<void> {
    ...
    public async getCherryPickConflicts(
        ...
        ): Promise<WebApi.PagedList<Git.GitConflict>> {
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<Git.GitConflict>>await response.text().then(deserializeVssJsonObject);
    ...
    public async getPullRequestCommits(
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<Git.GitCommitRef>>await response.text().then(deserializeVssJsonObject);
            body.continuationToken = response.headers.get("x-ms-continuationtoken");
            return body;
        });
    }
    ...
    public async getRefs(
        ...
        return this.beginRequest<Response>({
            ...
            const body = <WebApi.PagedList<Git.GitRef>>await response.text().then(deserializeVssJsonObject);
            body.continuationToken = response.headers.get("x-ms-continuationtoken");
            return body;
        });
    }
